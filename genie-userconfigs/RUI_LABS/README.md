...
# Future
```
qsub -j y -o cgenie_log -V -S /bin/bash runmuffin.sh muffin.CBE.worlg4.BASESFeTDTL RUI_LABS/future_foram pyyyyz.RpCO2_Rp13CO2.1p5deg.Albani.Foram.Transient 335 muffin.CB.worlg4.BASESFeTDTL.FORAM.SPIN
```
